...
public class MyTimerUtil {
    ...
    public static func sleep(_ time: TimeInterval, complete: @escaping () -> Void) {
        async{
    ...
    public static func  quick(complete: @escaping () -> Void) {
        sleep(0.02, complete: complete)
    }

    public static func after(complete: @escaping () -> Void) {
        sleep(0.03, complete: complete)
    }

    public static func  immediate(complete: @escaping () -> Void){
        sleep(0.2, complete: complete)
    }

    public static func  short(complete: @escaping () -> Void) {
        sleep(0.5, complete: complete)
    }

    public static func  sleep1(complete: @escaping () -> Void){
        sleep(1, complete: complete)
    }

    public static func  sleep2(complete: @escaping () -> Void) {
        sleep(2, complete: complete)
    }

    public static func  sleep3(complete: @escaping () -> Void) {
        sleep(3, complete: complete)
    }

    public static func  schedule(_ time: TimeInterval, complete: @escaping (Timer) -> Void) {
        Timer.scheduledTimer(withTimeInterval: time, repeats: true) { timer in
            complete(timer)
        }
    }

    public static func  schedule1(complete: @escaping (Timer) -> Void) {
    ...
    public static func animation3(complete: @escaping () -> Void) {
